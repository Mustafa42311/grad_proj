...
{
  RCLCPP_INFO(rclcpp::get_logger("WarehouseInterface"), "Starting robot hardware ...");
...
{
  RCLCPP_INFO(rclcpp::get_logger("WarehouseInterface"), "Stopping robot hardware ...");
  ...
  RCLCPP_INFO(rclcpp::get_logger("WarehouseInterface"), "Hardware stopped");
  return CallbackReturn::SUCCESS;
}
